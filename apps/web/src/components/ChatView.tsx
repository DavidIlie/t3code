...
const EMPTY_PROVIDER_COMMANDS_ARRAY: Array<{
  name: string;
  description: string;
  argumentHint: string;
}> = [];
...
export default function ChatView({ threadId }: ChatViewProps) {
  ...
  const composerMenuItems = useMemo<ComposerCommandItem[]>(() => {
    ...
    if (
      ...
      composerTrigger.kind === "provider-slash-command"
    ) {
    ...
    await (async () => {
      ...
      await api.orchestration.dispatchCommand({
        ...
        assistantDeliveryMode:
          selectedProvider === "claudeAgent" || settings.enableAssistantStreaming
            ? "streaming"
            : "buffered",
        runtimeMode,
        interactionMode,
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <div className="flex min-h-0 min-w-0 flex-1 flex-col">
          ...
          <div className={cn("px-3 pt-1.5 sm:px-5 sm:pt-2", isGitRepo ? "pb-1" : "pb-3 sm:pb-4")}>
            ...
            >
              <div
                className={`group rounded-[20px] border bg-card transition-colors duration-200 has-focus-visible:border-ring/45 ${
