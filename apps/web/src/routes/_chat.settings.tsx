    ...
    void action
      ...
      .catch(() => {
        toastManager.add({
          type: "error",
          title: installed
            ? "Failed to uninstall shell command"
            : "Failed to install shell command",
        });
      })
    ...
    <section className="rounded-2xl border border-border bg-card p-5">
      <div className="mb-4">
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          ...
          <code className="rounded bg-muted px-1 py-0.5 text-[10px]">gurt</code> CLI command so you
          can launch T3 Gurt from any terminal.
        </p>
      </div>
              ...
              <section className="rounded-2xl border border-border bg-card p-5">
                ...
                <div className="flex items-center justify-between rounded-lg border border-border bg-background px-3 py-2">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Show usage tier bars in the sidebar footer for at-a-glance rate limit
                      visibility.
                    </p>
                  </div>
                  <Switch
            ...
            {show.claude && (
              <section className="rounded-2xl border border-border bg-card p-5">
                <div className="mb-4">
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    These overrides apply to new sessions and let you use a custom Claude Code setup
                    or non-Anthropic endpoint.
                  </p>
                </div>
                ...
                <div className="flex items-center justify-between rounded-lg border border-border bg-background px-3 py-2">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      ...
                      <code className="rounded bg-muted px-1 py-0.5 text-[10px]">/debug</code> in
                      any chat.
                    </p>
                  </div>
                  <Switch
              ...
              <section className="rounded-2xl border border-border bg-card p-5">
                ...
                <label className="block space-y-1">
                  <Textarea
                    ...
                    onChange={(e) => updateSettings({ commitMessageInstructions: e.target.value })}
